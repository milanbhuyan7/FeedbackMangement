...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,feedbackmangement.onrender.com,feedback-mangement.vercel.app,', cast=lambda v: [s.strip() for s in v.split(',')])
